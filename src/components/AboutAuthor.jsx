            ...
            <div className="w-full md:w-2/3">
              ...
              <div className="mt-5 md:mt-16">
                <ul className="list-disc list-outside pl-5 sm:pl-6 text-gray-800 text-xl space-y-3">
                  <li>
                    <span className="font-bold">20+</span> years of experience
                  ...
                  <li>
                    ...
                    <span className="font-bold">engaging</span> teaching methods
                  </li>
                  <li>
                    Hosts vary by center but all bring{" "}
                    <span className="font-bold">extensive knowledge</span> and
                    dedication
                  </li>
                  <li>
                    Committed to{" "}
